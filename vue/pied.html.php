...
<script src="vue/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

<!-- Core plugin JavaScript (animation Scroll Up)-->
<script src="vue/vendor/jquery-easing/jquery.easing.min.js"></script>
